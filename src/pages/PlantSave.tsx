...
import { Alert, Text, View, Image, TouchableOpacity, StyleSheet, ScrollView, Platform } from 'react-native'
...
export function PlantSave() {
    ...
    function handleOpenDateForAndroid() {
        setShowDate(oldState => !oldState)
    }
            ...
            <View style={styles.container}>
                ...
                { 
                        ...
                        <DateTimePicker 
                            ...
                            // style={{maxHeight: '50%', borderWidth:5}} 
                        />)
                    }
                    {
                        Platform.OS === 'android' && (
                            <TouchableOpacity
                                style={styles.dateTimeForAndroid}
                                onPress={handleOpenDateForAndroid}
                            >
